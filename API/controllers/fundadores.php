...
if ($method === 'GET') {
    ...
    $result = $conn->query("SELECT ID, Nombre, Descripcion, Img FROM fundadores");
...
elseif ($method === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO fundadores (Nombre, Descripcion,Img) VALUES (:Nombre, :Descripcion,:Img)");
...
elseif ($method === 'DELETE') {
    ...
    $stmt = $conn->prepare("
      DELETE FROM fundadores WHERE ID=:ID
    ");
