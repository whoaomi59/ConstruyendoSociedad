...
if ($method === 'GET') {
    ...
    $result = $conn->query("SELECT ID, Nombre, Descripcion, Img FROM gerentes");
...
elseif ($method === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO gerentes (Nombre, Descripcion,Img) VALUES (:Nombre, :Descripcion,:Img)");
...
elseif ($method === 'DELETE') {
    ...
    $stmt = $conn->prepare("
      DELETE FROM gerentes WHERE ID=:ID
    ");
