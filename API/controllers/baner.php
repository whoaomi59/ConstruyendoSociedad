...
if ($method === 'GET') {
    ...
    $result = $conn->query("SELECT ID, Nombre, Descripcion, Img FROM baner");
...
elseif ($method === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO baner (Nombre, Descripcion,Img) VALUES (:Nombre, :Descripcion,:Img)");
