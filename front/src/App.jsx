    ...
    <>
      <header class="bg-blue-500">
        <nav class="container relative flex items-center justify-between px-6 py-8 mx-auto text-white">
          ...
          <div class="absolute inset-x-0 z-30 w-full px-6 py-8 mt-4 space-y-6 transition-all duration-300 ease-in-out bg-blue-600 top-16 md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:space-y-0 md:-mx-6 md:flex md:items-center">
            <a
              href="#"
              class="block text-white transition-colors duration-300 md:px-6 hover:text-blue-300"
            >
              Home
            </a>
            <a
      ...
      <main>
        <section>
          <div class="relative grid w-full bg-blue-500 h-96 lg:h-[32rem] place-items-center">
        ...
        <section class="container px-6 py-8 mx-auto lg:py-16" id="about">
          <div class="lg:flex lg:items-center lg:-mx-4">
            <div class="lg:w-1/2 lg:px-4">
              ...
              <button class="flex items-center mt-8 -mx-2 text-blue-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="w-8 h-8 mx-1"
                  fill="none"
        ...
        <section class="container px-6 py-8 mx-auto lg:py-16">
          ...
          <div class="flex items-center py-6 mt-4 -mx-2 overflow-x-auto whitespace-nowrap">
            <button class="inline-flex px-4 mx-2 focus:outline-none items-center py-0.5 text-white bg-blue-500 hover:bg-blue-400 duration-300 transition-colors rounded-2xl">
              All
            </button>
            <button class="inline-flex px-4 mx-2 duration-300 transition-colors hover:bg-blue-500/70 hover:text-white text-gray-500 focus:outline-none py-0.5 cursor-pointer rounded-2xl">
              Web Design
            </button>
            <button class="inline-flex px-4 mx-2 duration-300 transition-colors hover:bg-blue-500/70 hover:text-white text-gray-500 focus:outline-none py-0.5 cursor-pointer rounded-2xl">
              Development
